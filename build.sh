...
# Set Default Path
TOP_DIR=$PWD
KERNEL_PATH=/home/nightwatch/android/kernel/GT-I9300_Kernel

# TODO: Set toolchain and root filesystem path
TAR_NAME=zImage.tar

TOOLCHAIN="/home/nightwatch/android/toolchain/4.5/android-toolchain-eabi/bin/arm-eabi-"
...
cp -f $KERNEL_PATH/arch/arm/configs/u1_defconfig $KERNEL_PATH/.config
